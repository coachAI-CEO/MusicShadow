            ...
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        numberedStep(
                            number: "4",
                            title: "See the pattern shift",
                            text: "Over time, as you notice and name these patterns, your nervous system begins to recognize them—creating space for new responses."
                        )
                    }
                }
                .shadowCard()
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        bullet("Bring a clear, visual map of your activations into sessions with your therapist or coach.")
                    }
                }
                .shadowCard()
